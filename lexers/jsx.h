	...
	public:
		...
		Lexer() {
		    keywords = {
		        ...
		        "case", "break", "continue", "static", "true", "false", "null", "undefined", 
		        "void", "delete", "yield", "interface", "type", "as", "from", "in", "is"
		    };

		    reactKeywords = {
		        "useState", "useEffect", "useContext", "useReducer", "useCallback", 
		        "useMemo", "useRef", "useLayoutEffect", "useImperativeHandle", 
		        "Fragment", "createContext", "createRef", "forwardRef"
		    };
		    ...
		    operators = {
		        ...
		        {">=", TokenType::Operator}, {"<=", TokenType::Operator}, {"&&", TokenType::Operator},
		        {"||", TokenType::Operator}, {"!", TokenType::Operator}, {"?", TokenType::Operator},
		        {":", TokenType::Colon}, {"=>", TokenType::ArrowFunction}, {"...", TokenType::Destructuring},
		...
		void applyHighlighting(const std::string& code, std::vector<ImVec4>& colors, int start_pos) {
		    try {
		        ...
		        for (const auto& token : tokens) {
		            ...
		            if (token.start >= code.size()) continue;
		    ...
		    if (code[pos] == '<') {
		        ...
		        while (pos < code.length() && code[pos] != '>') {
		            ...
		            if (code[pos] == '=') {
		                ...
		                while (attrStart > start && !isWhitespace(code[attrStart-1])) attrStart--;
		...
		ImVec4 getColorForTokenType(TokenType type) const {
		    ...
		    switch (type) {
		        ...
		        case TokenType::Operator:
		            return ImVec4(cachedColors.text.x * 0.8f, cachedColors.text.y * 0.8f, 
		                         cachedColors.text.z * 0.8f, cachedColors.text.w);
