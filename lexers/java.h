...
enum class TokenType { Whitespace, Identifier, Keyword, PrimitiveType, String, CharLiteral, Number, Comment, Operator, Parenthesis, Bracket, Brace, Semicolon, Comma, Dot, Unknown, MethodName, ClassName, Annotation };
...
class Lexer
{
  public:
    ...
    Lexer()
    {
        keywords = {"abstract", "assert", "break", "case", "catch", "class", "const", "continue", "default", "do", "else", "enum", "extends", "final", "finally", "for", "goto", "if", "implements", "import", "instanceof", "interface", "native", "new", "package", "private", "protected", "public", "return", "static", "strictfp", "super", "switch", "synchronized", "this", "throw", "throws", "transient", "try", "volatile", "while", "exports", "module", "non-sealed", "open", "opens", "permits", "provides", "record", "requires", "sealed", "to", "transitive", "uses", "var", "when", "yield"};
        primitiveTypes = {"boolean", "byte", "char", "short", "int", "long", "float", "double", "void"};
        literals = {"true", "false", "null"};
        operators = {{"<<=", TokenType::Operator}, {">>=", TokenType::Operator}, {">>>=", TokenType::Operator}, {"==", TokenType::Operator}, {"!=", TokenType::Operator}, {">=", TokenType::Operator}, {"<=", TokenType::Operator}, {"&&", TokenType::Operator}, {"||", TokenType::Operator}, {"++", TokenType::Operator}, {"--", TokenType::Operator}, {"+=", TokenType::Operator}, {"-=", TokenType::Operator}, {"*=", TokenType::Operator}, {"/=", TokenType::Operator}, {"%=", TokenType::Operator}, {"&=", TokenType::Operator}, {"|=", TokenType::Operator}, {"^=", TokenType::Operator}, {"<<", TokenType::Operator},
  ...
  private:
    ...
    void updateThemeColors() const
    {
        ...
        try {
            ...
            cachedColors.className = loadColor("class_name", cachedColors.primitiveType); // <<< CORRECTED DEFAULT
    ...
    bool isJavaIdentifierPart(char c) const { return (isAlpha(c) || isDigit(c)) || c == '_' || c == '$'; } // <<< CORRECTED
    ...
    Token lexNumber(const std::string &code, size_t &pos)
    {
        ...
        if (!potentialFloatChars && pos < code.length() && (code[pos] == 'l' || code[pos] == 'L')) {
            ...
            else {     // Check if Decimal/Octal was truly integer
