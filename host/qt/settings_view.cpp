...
SettingsView::SettingsView(Settings &settings, QWidget *parent)
...
QWidget *SettingsView::makeSection(const QString &title)
{
...
void SettingsView::paintSwatch(QPushButton *swatch, const QColor &color)
{
...
void SettingsView::commit()
{
	...
	appSettings.settings["font"] = family == QLatin1String("System Default")
...
void SettingsView::syncFromSettings()
{
	themeBox->setCurrentText(QString::fromStdString(appSettings.activeProfileFile()));
	stagedProfileFile = appSettings.activeProfileFile();
...
void SettingsView::onProfileChanged()
{
