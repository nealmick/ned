/*
File: font.cpp
Description: Font management class implementation for loading and managing ImGui fonts.
*/
...
// Include FreeType headers if available
#ifdef IMGUI_ENABLE_FREETYPE
#include "misc/freetype/imgui_freetype.h"
#endif

// Forward declaration for global settings
...
void Font::initialize()
{
	...
	// Load fonts with temporary font size
