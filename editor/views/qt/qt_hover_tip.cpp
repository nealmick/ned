...
QtHoverTip::QtHoverTip(QWidget *parent)
	: QWidget(parent,
...
void QtHoverTip::present(const QString &html,
						 const QFont &font,
						 const QColor &bg,
						 const QColor &ink,
...
void QtHoverTip::replaceAt(const QPoint &globalAnchor)
{
	if (isVisible())
		placeAt(globalAnchor);
}

void QtHoverTip::placeAt(const QPoint &globalAnchor)
{
