...
bool LspImGuiView::keybinds()
{
	...
	ImGuiKey symbolInfoKey = client.settingsKeybinds().getActionKey("lsp_symbol_info");
	...
	ImGuiKey gotoDefKey = client.settingsKeybinds().getActionKey("lsp_find_def");
	...
	ImGuiKey gotoRefKey = client.settingsKeybinds().getActionKey("lsp_find_ref");
