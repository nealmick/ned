/*
	File: views/qt/qt_lsp_uri_options.h
...
class QtLspUriOptions : public QDialog
{
	Q_OBJECT

  public:
	explicit QtLspUriOptions(QWidget *parent);
  ...
  protected:
	...
	// This dialog is long-lived (built once with LspQtView), so its card
