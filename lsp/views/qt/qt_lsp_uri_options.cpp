...
QtLspUriOptions::QtLspUriOptions(QWidget *parent) : QDialog(parent, Qt::Popup)
{
	setModal(true);
...
void QtLspUriOptions::present(const std::string &titleTextIn,
...
bool QtLspUriOptions::eventFilter(QObject *watched, QEvent *event)
{
...
void QtLspUriOptions::keyPressEvent(QKeyEvent *event)
{
...
void QtLspUriOptions::showEvent(QShowEvent *event)
{
...
void QtLspUriOptions::hideEvent(QHideEvent *event)
{
